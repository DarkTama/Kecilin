...
- **Files or folders, output anywhere** — add individual videos via picker or drag-and-drop alongside folder scans, and optionally redirect all output to a folder of your choice.
